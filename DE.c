...
#define F 0.5                        // F:ccntrols the amplification of the differential variation
#define CR 0.1                       // CRCcrossover constant
#define VTR 0.001                    // VTR:Value to reach
#define NAME "Griewangk_general.csv" // output file name
#define GEN_MAX 1000                 // generation max number
*/
